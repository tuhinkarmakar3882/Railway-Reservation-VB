...
Dim spval As Integer
Dim splad As Integer
Dim ad As Integer
...
Adodc3.RecordSource = "select * from seats where Train_No = " & Text1.Text & " AND class = '" & Combo7.Text & "' "
'Connect (s)
'Set Text66.DataSource = rs2
...
If Day(DTPicker1) < Day(Now) And Month(DTPicker1) <= Month(Now) And Year(DTPicker1) <= Year(Now) Then
MsgBox ("Sorry.You can't book a ticket for this date.")
Exit Sub
Else
If Month(DTPicker1) <= (Month(Now) Mod 12) + 4 And Year(DTPicker1) = Year(Now) Then
'MsgBox ("Sorry.You can book a ticket only after four months from the curent date")
Else
MsgBox ("Sorry.You can book a ticket only after four months from the curent date")
Exit Sub
'If Month(DTPicker1)
...
Exit Sub
End If
Form16.Label9.Caption = Form2.Text18.Text

Form16.Label3.Caption = Form2.Text5.Text
Form16.Label4.Caption = Form2.Text6.Text
Form16.Label5.Caption = Form2.Text7.Text

Form16.Label6.Caption = Form2.Text8.Text
Form16.Label7.Caption = Form2.Text9.Text
Form16.Label8.Caption = Form2.Text10.Text

Form16.Label23.Caption = Form2.Text11.Text
Form16.Label22.Caption = Form2.Text12.Text
Form16.Label21.Caption = Form2.Text13.Text

Form16.Label20.Caption = Form2.Text14.Text
Form16.Label19.Caption = Form2.Text15.Text
Form16.Label18.Caption = Form2.Text16.Text

Form16.Label29.Caption = Form2.Combo1.Text
Form16.Label28.Caption = Form2.Combo2.Text
Form16.Label27.Caption = Form2.Combo3.Text

Form16.Label26.Caption = Form2.Combo4.Text
Form16.Label25.Caption = Form2.Combo5.Text
Form16.Label24.Caption = Form2.Combo6.Text

Form16.Label31.Caption = Form2.Combo7.Text

Form16.Label10.Caption = Form2.DTPicker1.Value
...
If Val(Form2.Text1.Text) = 1 Then
Form16.Label34.Caption = "9:15 AM"
Form16.Label36.Caption = "9:05 AM (Next Day)"
Form16.Label37.Caption = "1243576854"

'Form20.Text1.Text = Form16.Label37.Caption

End If
If Val(Form2.Text1.Text) = 2 Then
Form16.Label34.Caption = "10:25 AM"
Form16.Label36.Caption = "10:15 AM (Next Day)"
Form16.Label37.Caption = "3546732124"
End If
If Val(Form2.Text1.Text) = 3 Then
Form16.Label34.Caption = "11:35 AM"
Form16.Label36.Caption = "11:25 AM (Next Day)"
Form16.Label37.Caption = "5678912334"
End If
If Val(Form2.Text1.Text) = 4 Then
Form16.Label34.Caption = "12:45 PM"
Form16.Label36.Caption = "12:35 PM (Next Day)"
Form16.Label37.Caption = "9899754421"
End If
If Val(Form2.Text1.Text) = 5 Then
Form16.Label34.Caption = "1:55 PM"
Form16.Label36.Caption = "1:45 PM (Next Day)"
Form16.Label37.Caption = "5477632196"
End If
If Val(Form2.Text1.Text) = 6 Then
Form16.Label34.Caption = "3:05 PM"
Form16.Label36.Caption = "2:55 AM (Next Day)"
Form16.Label37.Caption = "8778455432"
End If
If Val(Form2.Text1.Text) = 7 Then
Form16.Label34.Caption = "4:15 PM"
Form16.Label36.Caption = "4:05 AM (Next Day)"
Form16.Label37.Caption = "9623541870"
End If
If Val(Form2.Text1.Text) = 8 Then
Form16.Label34.Caption = "5:25 PM"
Form16.Label36.Caption = "5:55 AM (Next Day)"
Form16.Label37.Caption = "4913062044"
End If
If Val(Form2.Text1.Text) = 9 Then
Form16.Label34.Caption = "6:25 PM"
Form16.Label36.Caption = "6:15 PM (Next Day)"
Form16.Label37.Caption = "1639854290"
End If
...
Form16.Label11.Caption = Text19.Text
Form16.Label12.Caption = Text20.Text
Form3.Text16.Text = Text1.Text
Form3.Label14.Caption = Text18.Text
Form3.Text17.Text = Combo7.Text


If Text5.Text = "" Or Text11.Text = "" Or Combo1.Text = "" Then
MsgBox ("Oops! You should enter your details properly")
Form3.Hide
Exit Sub
Else
Me.Hide
...
If Val(Text11.Text) <= 5 Then
Child = Child + 1
Else
    If Val(Text11.Text) >= 60 Then
    Senior = Senior + 1
    Else
    Adult = Adult + 1
    End If
...
If Text6.Text = "" Or Text12.Text = "" Or Combo2.Text = "" Then
Form3.Text1 = Adult
Form3.Text2 = Child
Form3.Text3 = Senior
ad = Val(Form3.Text2.Text) + Val(Form3.Text3.Text)
If ad = 0 Then
Form16.Label13.Caption = "29 UB"
Form3.Show
Else
RESET.Show
Form3.Hide
...
If Text7.Text = "" Or Text13.Text = "" Or Combo3.Text = "" Then
Form3.Text1 = Adult
Form3.Text2 = Child
Form3.Text3 = Senior
ad = Val(Form3.Text2.Text) + Val(Form3.Text3.Text)
If ad = 0 Then
Form16.Label13.Caption = "2 MB"
Form16.Label13.Caption = Form16.Label13.Caption + "8 SU"
Form3.Show
Else
RESET.Show
Form3.Hide
...
Exit Sub
Else
If Val(Text13.Text) <= 5 Then
Child = Child + 1
Else
    If Val(Text13.Text) >= 60 Then
    Senior = Senior + 1
    Else
    Adult = Adult + 1
    End If
...
If Text8.Text = "" Or Text14.Text = "" Or Combo4.Text = "" Then
Form3.Text1 = Adult
Form3.Text2 = Child
Form3.Text3 = Senior
ad = Val(Form3.Text2.Text) + Val(Form3.Text3.Text)
If ad = 0 Then
Form16.Label13.Caption = "3 UB"
Form16.Label13.Caption = Form16.Label13.Caption + "10 MB"
Form16.Label13.Caption = Form16.Label13.Caption + "11 UB"
Form3.Show
Else
RESET.Show
Form3.Hide
...
Exit Sub
Else
If Val(Text14.Text) <= 5 Then
Child = Child + 1
Else
    If Val(Text14.Text) >= 60 Then
    Senior = Senior + 1
    Else
    Adult = Adult + 1
    End If
...
'Correction needed
If Text9.Text = "" Or Text15.Text = "" Or Combo5.Text = "" Then
Form3.Text1 = Adult
Form3.Text2 = Child
Form3.Text3 = Senior
ad = Val(Form3.Text2.Text) + Val(Form3.Text3.Text)
If ad = 0 Then
Form16.Label13.Caption = "2 MB"
Form16.Label13.Caption = Form16.Label13.Caption + "8 MB"
Form16.Label13.Caption = Form16.Label13.Caption + "36 MB"
Form16.Label13.Caption = Form16.Label13.Caption + "39 SL"
Form3.Show
Else
RESET.Show
Form3.Hide
...
Exit Sub
Else
If Val(Text15.Text) <= 5 Then
Child = Child + 1
Else
    If Val(Text15.Text) >= 60 Then
    Senior = Senior + 1
    Else
    Adult = Adult + 1
    End If
...
If Text10.Text = "" Or Text16.Text = "" Or Combo6.Text = "" Then
Form3.Text1 = Adult
Form3.Text2 = Child
Form3.Text3 = Senior
ad = Val(Form3.Text2.Text) + Val(Form3.Text3.Text)
...
Form16.Label13.Caption = "2 MB"
Form16.Label13.Caption = Form16.Label13.Caption + "8 MB"
Form16.Label13.Caption = Form16.Label13.Caption + "29 UB"
Form16.Label13.Caption = Form16.Label13.Caption + "36 MB"
Form16.Label13.Caption = Form16.Label13.Caption + "39 SL"
Form3.Show
Else
...
Exit Sub
Else
If Val(Text16.Text) <= 5 Then
Child = Child + 1
Else
    If Val(Text16.Text) >= 60 Then
    Senior = Senior + 1
    Else
    Adult = Adult + 1
    End If
...
ad = Val(Form3.Text2.Text) + Val(Form3.Text3.Text)
If ad = 0 Then
Form16.Label13.Caption = "42 MB"
Form16.Label13.Caption = Form16.Label13.Caption + "46 MB"
Form16.Label13.Caption = Form16.Label13.Caption + "37 UB"
Form16.Label13.Caption = Form16.Label13.Caption + "36 MB"
Form16.Label13.Caption = Form16.Label13.Caption + "39 SL"
Form16.Label13.Caption = Form16.Label13.Caption + "10 MB"
Form3.Show
...
rs6.AddNew
Text1.Text = Temp1
Adodc1.RecordSource = "select *from Trains where Train_No='" + Combo1.Text + "'"
